...
describe("lockpay_initialize_vault.ts", () => {
  it("builds InitializeVault ix and sends tx", async () => {
    jest.resetModules();
    ...
    jest.isolateModules(() => {
      require("../cluster1/lockpay_initialize_vault");
    });
    ...
    expect(ix.data.length).to.eq(48);
